            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('appointment.store', $service) }}" method="post" class="php-email-form">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" readonly class="form-control" id="name" placeholder="Order ID"
                                    value="{{ $service->order_id }}" disabled required>
                            </div>
                            ...
                            <div class="form-group">
                                <input type="text" readonly class="form-control" id="alamat"
                                    placeholder="Alamat Belum Diisi" disabled value="{{ $service->user->client->alamat }}"
                                    required>
                                <small>
                            ...
                            <div class="mt-3 text-center"><button class="btn btn-primary" type="submit">Create</button>
                            </div>
                        </form>
                    </div>
                </div>
