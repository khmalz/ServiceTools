                        ...
                        <div class="card-body d-flex justify-content-between align-items-center py-3">
                            <div>
                                <h6 class="text-dark m-0">
                                    <span>There's new appointment task for a <a
                                            href="{{ route('appointment.show', $notification->data['order_id']) }}"
                            ...
                            <div>
                                @if ($notification->unread())
                                    <form method="POST" action="{{ route('admin.inbox.read', $notification->id) }}">
                                        @csrf
